...
include_once __DIR__ . '/../../app/models/BeritaModel.php';
...
<head>
    ...
    <title>Edit Berita - Naureen Mini Garden</title>
        ...
        <div class="container-fluid p-4 pt-3">
            <div class="nmg-add-news-container">
                <header class="mb-4 text-center" data-aos="fade-down" data-aos-duration="800">
                    <h2 class="fw-bold" style="color: #2c3e2d; margin-bottom: 0;">Edit Berita</h2>
                    <p class="text-muted small">Perbarui informasi berita yang sudah ada.</p>
                </header>
                    ...
                    <div class="row g-4"> 
                        <div class="col-lg-5" data-aos="fade-right" data-aos-delay="100">
                            <div class="nmg-section">
                                ...
                                <div class="nmg-upload-area position-relative" onclick="document.getElementById('input-file').click()" style="height: 220px; overflow: hidden; padding: 0;">
                                    
                                    <input type="file" name="gambar" id="input-file" accept="image/*" onchange="previewImage(event)" 
                                        style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%); opacity: 0; z-index: -1;">
                                    
                                    <div id="upload-placeholder" class="text-center p-2" style="display: none;">
                                        <div class="nmg-upload-icon mx-auto shadow-sm" style="width: 60px; height: 60px;">
                                            <i class="bi bi-image-fill fs-3"></i>
                                        </div>
                                        <p class="fw-bold mb-0" style="font-size: 0.95rem; color: #6c757d;">Pilih foto baru</p>
                                    </div>

                                    <img id="image-preview" src="../../assets/uploads/<?= $data['gambar']; ?>" alt="Preview" style="display: block; width:100%; height:100%; object-fit:cover;">
                                    ...
                                    <button type="button" id="btn-trash" class="btn btn-danger position-absolute shadow-sm" 
                                            ...
                                            onclick="removeImage(event)" title="Batalkan Gambar Baru">
                            ...
                            <div class="nmg-section mt-4">
                                ...
                                <input type="date" name="tanggal_kegiatan" class="form-control" value="<?= htmlspecialchars($data['tanggal_kegiatan']); ?>" required>
                            </div>
                        </div> 
                        ...
                        <div class="col-lg-7" data-aos="fade-left" data-aos-delay="200">
                            <div class="nmg-section h-100 d-flex flex-column">
                                ...
                                <textarea name="deskripsi" class="form-control flex-grow-1" style="min-height: 480px; resize: none;" required><?= htmlspecialchars($data['deskripsi']); ?></textarea>
                            </div>
                        </div> 
                        ...
                        <div class="col-12 mt-4" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="d-flex justify-content-end align-items-center gap-3">
                                ...
                                <button type="submit" name="edit_berita" class="nmg-btn-save shadow-sm">
...
<script>
    ...
    const oldImageUrl = "../../assets/uploads/<?= $data['gambar']; ?>";
